...
import BillTypeReport from "../billTypeTable";
import CategoryReport from "../categoryTable";
   ...
   return (
      <Box sx={{ width: '100%' }}  textcolor={colors.grey[200]}>
         ...
         <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
            <Tab label="VAT & PAN Bills" {...a11yProps(0)}/>
            <Tab label="Bill Categories" {...a11yProps(1)}/>
         </Tabs>
         </Box>
